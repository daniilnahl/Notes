...
## How does it work?
1. Data enters through an input layer.
2. It is processed through one or more hidden layers.
3. A result roduced at the output layer. 

### What happens in between layers?
There are connections between each layers and these connections have weights.

#### Weights?
- Each connection between neurons has an associated weight. This weight defines how strong a connection is between two neurons. Weight can be on a scale from -1 to 1.
- Weights are adjusted during training via an algorithm. 
...
# What about the Math behind Neural Networks?
